...
abstract class backup_external_courses_helper {
    ...
    public static function run_external_backup($courseid, $userid) {
        ...
        if ($status) {
            //mtrace('Running backup of external courses...');
        ...
        //TODO remove
        //$emailpending = true;
        //clean directory from old backups
        //$removedcount = backup_external_courses_helper::remove_old_backups();

        //mtrace('External Backups courses complete.');
